...
class Option {
    ...
    *[Symbol.iterator]() {
    ...
    okOr(err) {
        return this.isSome() ? (0, result_js_1.Ok)(this.value) : (0, result_js_1.Err)(err);
    }
    okOrElse(callback) {
        return this.isSome() ? (0, result_js_1.Ok)(this.value) : (0, result_js_1.Err)(callback());
    }
    or(option) {
    ...
    transpose() {
        return this.isNone()
            ? (0, result_js_1.Ok)(this)
            : (this.value.isOk()
                ? (0, result_js_1.Ok)(Some(this.value.unwrap()))
                : (0, result_js_1.Err)(this.value.unwrapErr()));
    }
    unwrap() {
